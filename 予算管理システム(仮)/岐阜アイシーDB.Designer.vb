...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("岐阜アイシーDB"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class 岐阜アイシーDB
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As 岐阜アイシーDB = CType(MyBase.Clone,岐阜アイシーDB)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "岐阜アイシーDB"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/岐阜アイシーDB.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As 岐阜アイシーDB = New 岐阜アイシーDB()
...
Namespace 岐阜アイシーDBTableAdapters
    ...
    Partial Public Class M_TORTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM ""CAP21_02"".""M_TOR"" WHERE ((""CODE"" = :Original_CODE) AND ((:IsNull_NAM"& _ 
                "E = 1 AND ""NAME"" IS NULL) OR (""NAME"" = :Original_NAME)) AND ((:IsNull_KANA = 1 A"& _ 
                "ND ""KANA"" IS NULL) OR (""KANA"" = :Original_KANA)) AND ((:IsNull_ADDRESS1 = 1 AND "& _ 
                """ADDRESS1"" IS NULL) OR (""ADDRESS1"" = :Original_ADDRESS1)) AND ((:IsNull_ADDRESS2"& _ 
                " = 1 AND ""ADDRESS2"" IS NULL) OR (""ADDRESS2"" = :Original_ADDRESS2)) AND ((:IsNull"& _ 
                "_TEL = 1 AND ""TEL"" IS NULL) OR (""TEL"" = :Original_TEL)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO ""CAP21_02"".""M_TOR"" (""CODE"", ""NAME"", ""KANA"", ""ADDRESS1"", ""ADDRESS2"", """& _ 
                "TEL"") VALUES (:CODE, :NAME, :KANA, :ADDRESS1, :ADDRESS2, :TEL)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE ""CAP21_02"".""M_TOR"" SET ""CODE"" = :CODE, ""NAME"" = :NAME, ""KANA"" = :KANA, ""AD"& _ 
                "DRESS1"" = :ADDRESS1, ""ADDRESS2"" = :ADDRESS2, ""TEL"" = :TEL WHERE ((""CODE"" = :Orig"& _ 
                "inal_CODE) AND ((:IsNull_NAME = 1 AND ""NAME"" IS NULL) OR (""NAME"" = :Original_NAM"& _ 
                "E)) AND ((:IsNull_KANA = 1 AND ""KANA"" IS NULL) OR (""KANA"" = :Original_KANA)) AND"& _ 
                ...
                "nal_ADDRESS2)) AND ((:IsNull_TEL = 1 AND ""TEL"" IS NULL) OR (""TEL"" = :Original_TE"& _ 
                "L)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.予算管理システム_仮_.My.MySettings.Default.ConnectionString1
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT CODE, NAME, KANA, ADDRESS1, ADDRESS2, TEL FROM CAP21_02.M_TOR"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As 岐阜アイシーDB.M_TORDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As 岐阜アイシーDB.M_TORDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As 岐阜アイシーDB.M_TORDataTable = New 岐阜アイシーDB.M_TORDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As 岐阜アイシーDB.M_TORDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As 岐阜アイシーDB) As Integer
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As 岐阜アイシーDB, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As 岐阜アイシーDB, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._m_TORTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As 岐阜アイシーDB, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._m_TORTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As 岐阜アイシーDB) As Integer
